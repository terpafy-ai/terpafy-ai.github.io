 ...
 * Static demo chat widget displayed in the hero right column.
...
export function ChatPreview() {
  return (
    <div className="relative flex h-[580px] w-[355px] flex-col overflow-hidden rounded-2xl border border-white/15 bg-[#222] select-none">
      {/* Ambient glow — simplified from Figma gradient bg */}
      ...
      <div className="relative z-10 shrink-0 px-3 pb-3 pt-1">
        <div className="flex items-center gap-2 rounded-[10px] border border-white/20 bg-white/5 px-3 py-1.5 backdrop-blur-md">
          ...
          <div
            className="flex size-[44px] shrink-0 items-center justify-center rounded-[10px] border border-primary"
            style={{
              background:
            ...
            aria-hidden="true"
          >
            <Send variant="Bold" className="size-5 text-white" />
          </div>
        </div>
      </div>
    </div>
