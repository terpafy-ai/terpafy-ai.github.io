  ...
  return (
    <section id="features" className="bg-background py-16 sm:py-24">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        {/* Highlight card */}
        <div className="mt-10 flex flex-col gap-[10px] rounded-[4px] border border-[#f2594b] bg-muted px-[32px] py-[16px]">
          <I3DCubeScan
            variant="Bold"
        ...
        <div className="mt-8 grid grid-cols-1 gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
          {FEATURE_KEYS.map((key) => (
            <div
              key={key}
              className="flex flex-col gap-[10px] rounded-[4px] border border-border bg-muted px-[32px] py-[16px]"
            >
              <I3DCubeScan
                variant="Bold"
                className="size-[24px] text-foreground-muted"
                aria-hidden="true"
              />
              <p className="text-[14px] font-bold text-foreground-muted">
